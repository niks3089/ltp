...
uint8_t ipaddr[4] = { 0x0c, 0x00, 0x00, 0x22 }; /* 12.0.0.2 */
uint8_t srcaddr[4] = { 0x0c, 0x00, 0x00, 0x12 }; /* 12.0.0.2 */
uint8_t macaddr[HLEN_ETHER] = {0x02, 0x01, 0x02, 0x03, 0x04, 0x10}; // Hardcode this based on tap100
uint8_t macaddr_brd[HLEN_ETHER] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };

static void setup(void)
{
    // Assume tap interface is created
    const char *ifname = "tap102";
    int err;
    struct ifreq ifr;
